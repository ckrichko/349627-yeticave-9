    ...
    <?php foreach ($lots as $lot => $key): ?>
      <li class="lots__item lot">
        ...
        <div class="lot__info">
          ...
          <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?= htmlspecialchars($key['title']) ?></a>
          </h3>
          <div class="lot__state">
            <div class="lot__rate">
              <span class="lot__amount">Стартовая цена</span>
              <span class="lot__cost"><?= formatCurrency($key['price']); ?><b class="rub">р</b></span>
            </div>
            <div
              class="lot__timer timer <?php if (timeToEndLessOneHour($key['time'])): ?>timer--finishing<?php endif; ?>">
              <?= timeToEnd($key['time']) ?>
            </div>
          </div>
        </div>

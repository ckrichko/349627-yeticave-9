...
(id, name, code) VALUES ('1', 'Доски и лыжи', 'skiing'), ('2', 'Крепления', 'mounts'), ('3', 'Ботинки', 'boots'),
  ('4', 'Одежда', 'clothing'), ('5', 'Инструменты', 'tools'), ('6', 'Разное', 'other');

INSERT INTO users
(id, email, password, name, contact, avatar_url)
VALUES
...
INSERT INTO lots
(id, name, description, image_url, category_id, start_price, end_at, bid_step, creator_id)
VALUES
  ('1', '2014 Rossignol District Snowboard', 'Описание лота №1', 'img/lot-1.jpg', '1', '10999', '2019-04-30', '100',
   '1'),
  ('2', 'DC Ply Mens 2016/2017 Snowboard', 'Описание лота №2', 'img/lot-2.jpg', '1', '159999', '2019-04-30', '100',
   '2'),
  ('3', 'Крепления Union Contact Pro 2015 года размер L/XL', 'Описание лота №3', 'img/lot-3.jpg', '2', '8000',
   '2019-04-28', '100', '1'),
  ('4', 'Ботинки для сноуборда DC Mutiny Charocal', 'Описание лота №4', 'img/lot-4.jpg', '3', '10999', '2019-04-29',
   '100', '1'),
  ('5', 'Куртка для сноуборда DC Mutiny Charocal', 'Описание лота №5', 'img/lot-5.jpg', '4', '7500', '2019-04-29',
   '100', '2'),
  ('6', 'Маска Oakley Canopy', 'Описание лота №6', 'img/lot-6.jpg', '6', '5400', '2019-04-28', '100', '2');

INSERT INTO bids
(id, amount, created_at, user_id, lot_id)
VALUES
